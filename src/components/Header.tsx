  ...
  return (
    <header className="w-full border-b-4 border-black mb-12 bg-white sticky top-0 z-50">
      <div className="max-w-screen-xl mx-auto px-4 md:px-8 py-4">
        ...
        {/* 네비게이션 */}
        <nav className="flex justify-center gap-8 md:gap-12 py-3 font-black text-[10px] tracking-[0.4em] text-gray-600">
          ...
          <a href="#shop"     className="hover:text-black transition-colors border-b border-transparent hover:border-black pb-0.5">SHOP</a>
          <a href="https://queenofboard.vercel.app/board" target="_blank" rel="noopener noreferrer"
